...
4. 关闭Chrome浏览器, 用命令行执行以下命令
   + Windows(PowerShell): `irm https://raw.githubusercontent.com/appsail/Gemini-in-Chrome/main/install.ps1 | iex`
   + Mac: `open -n -a "Google Chrome" --args --variations-override-countrys=us`
